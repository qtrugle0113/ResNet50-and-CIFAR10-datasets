...
train_dataset = torchvision.datasets.CIFAR10(root='../osproj/data/',
                                             ...
                                             download=True) # Change Download-flag "True" at the first excution to download CIFAR10 dataset
...
PATH = './resnet50_epoch285.ckpt' # be almost 80
...
# Train Model
# Hyper-parameters
num_epochs = 1  # In this project I only train 1 epoch because i will use cpu
learning_rate = 0.001
